...
namespace Pixelwars
{
    class PlayerTwo
    {
        ...
        public bool Intersects(PlayerOne playerOne)
        {
            if (Player_box.Intersects(new Rectangle((int)playerOne.Position.X, (int)playerOne.Position.Y, (int)playerOne.Size.X, (int)playerOne.Size.Y)))
            {
                return true;
            }
            return false;
        ...
        public PlayerTwo(int x, int y, GraphicsDeviceManager graphics)
        {
